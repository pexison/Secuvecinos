//
//  ReportEventPhotoViewController.swift
//  Secuvecinos
//
//  Created by John on 23/2/16.
...
class ReportEventPhotoViewController: UIViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        DestViewController.selectedImage = imageView.image
    }
    ...
    override func viewDidLoad() {
        ...
        imageView.image = image
        self.title = "Seleccionar foto del evento"
    }
